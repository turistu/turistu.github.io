...
- ... that on a typical linux system a user can bypass their ssh login shell (and any `ForceCommand`) and [run any command they like](https://github.com/turistu/odds-n-ends/blob/main/CVE-2025-14282.md#3)?
