...
- ... that on a typical linux system a user can [bypass their ssh login shell](https://github.com/turistu/odds-n-ends/blob/main/CVE-2025-14282.md#3) (and any `ForceCommand`) and run any command they like?
